...
class EverPhotoTableViewController: UITableViewController {
    ...
    var phase_ = ["素颜", "改造", "水电", "木工", "泥工", "油漆", "墙纸", "软装"]
    var phaseTips_ = ["开始动工前，给您的爱家留个影吧~", "我的房子我做主，想要几房要房~", "线管走向务必拍照哦，后期打洞洞不小心打到了可不是闹着玩滴~", "除了秀下木工师傅手艺，还能干嘛~", "瓷砖贴上大大提升房主逼格~", "我家的样子开始显现了哦~", "墙纸还是壁画？还是墙纸吧，谁用谁知道~", "哇塞，美得一塌糊涂"]
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        var alertController = UIAlertController(title: "敬请期待", message: "你造吗，这是款众多装修业主一起打造的产品，你要不要参与呢~", preferredStyle: UIAlertControllerStyle.Alert)
