...
class RecordPayViewController: FormViewController, FormViewControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.delegate = self
        self.navigationItem.rightBarButtonItem = UIBarButtonItem(title: "完成", style: UIBarButtonItemStyle.Plain, target: self, action: #selector(RecordPayViewController.submit(_:)))
    }
...
//    }
    ...
    func submit(_: UIBarButtonItem!) {
        ...
        print(order_.recordDescription())
