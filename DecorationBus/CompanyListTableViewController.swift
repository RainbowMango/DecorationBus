...
class CompanyListTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //添加下拉刷新控件
        tableHeader = MJRefreshNormalHeader(refreshingTarget: self, refreshingAction: #selector(CompanyListTableViewController.tableHeaderRefresh))
        tableHeader.automaticallyChangeAlpha = true
        self.tableView.tableHeaderView = tableHeader
        
        //添加上拉刷新控件
        tableFooter = MJRefreshAutoNormalFooter(refreshingTarget: self, refreshingAction: #selector(CompanyListTableViewController.tableFooterRefresh))
